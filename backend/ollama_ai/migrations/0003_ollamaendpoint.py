...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ollama_ai', '0002_update_default_api_endpoint'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_endpoints', to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
            ],
            options={
